# -*- coding: utf-8 -*-
# 自动导入：spine-renpy 引擎包复制到目标项目的 game/renpy-spine-plugin/ 即生效。
...
init python early:
    ...
    # 注册前缀让 RenpyImporter 从 loader 虚拟文件系统解析 renpy-spine-plugin/ 下模块
    renpy.add_python_directory("renpy-spine-plugin")
    spine_dir = renpy.config.gamedir + "/renpy-spine-plugin"
